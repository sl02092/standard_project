"""
step43d7_prompt_compare_dinov2_internvl38b_003.py — Context-aware A/B prompt evaluation 
...
Updated to implement the Forced Attention Sandwich Layout, matching the sequence 
token alignment structure from train_step43d7_hybrid_003.py.
"""
