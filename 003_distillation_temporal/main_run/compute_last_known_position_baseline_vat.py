...
#
# FIXED 2026-08-12: this file was renamed to temporal_window_dataset_vat.py
# for consistency with the other three datasets' own naming, but this
# import still referenced the old, unsuffixed name -- always failed
# silently, meaning the VAL-SPLIT ONLY breakdown below never ran. Doesn't
# affect train_temporal_v1.py or any actual result (it imports the
# correctly-named module directly, never touches this file's own internal
# import) -- only this script's own standalone main() was affected.
try:
    from temporal_window_dataset_vat import build_clip_split
except ImportError:
    build_clip_split = None
    print("[baseline] temporal_window_dataset_vat.py not importable from "
          "this directory -- val-split-restricted breakdown will be "
          "skipped. Full-manifest breakdown still runs.")
