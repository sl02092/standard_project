...
PROMPT_TEST = False
TEST_MODE   = False  # TEST_MODE run (2026-07-03) passed clean: 0 errors,
                      # 100% parse rate, dtype/routing/checkpointing all
                      # confirmed working with this prompt. Ready for full run.
