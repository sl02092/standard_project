...
# UNCHANGED: same model/prompt as every other dataset.
TEACHER_VERSION_SOCIAL = "internvl3-8b-v4-prompt"
TEACHER_VERSION_HYBRID = "internvl3+gdino-base-v2-targeted"

_OUT_PREFIX = os.environ.get("TEACHER_OUTPUT_PREFIX", "vacation_hybrid_targeted")
if PROMPT_TEST:
...
# Same probe set as step40 -- videos 106/170, the two directly verified
# against real data during manifest-building.
PROMPT_TEST_N     = 10
